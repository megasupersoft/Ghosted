...
function overRest(func, start, transform3) {
  ...
  return function() {
    var args = arguments, index7 = -1, length = nativeMax4(args.length - start, 0), array2 = Array(length);
    while (++index7 < length) {
...
var pullAt = flatRest_default(function(array2, indexes2) {
  ...
  basePullAt_default(array2, arrayMap_default(indexes2, function(index7) {
...
function remove(array2, predicate) {
  ...
  var index7 = -1, indexes2 = [], length = array2.length;
...
var _default = function() {
  ...
  return _createClass2(_default11, [{
    ...
    value: function lookup(color) {
      ...
      var n2 = typeof color === "string" ? colorStr2Int(color) : rgb2Int.apply(void 0, _toConsumableArray(color));
      if (!n2) return null;
...
function link_default(links) {
  var id = index5, strength = defaultStrength, strengths, distance2 = constant_default2(30), distances, nodes, nDim, count2, bias, random2, iterations = 1;
  if (links == null) links = [];
    ...
    tickFrame: function tickFrame(state) {
      ...
      function paintLinks() {
        ...
        Object.entries(linksPerColor).forEach(function(_ref) {
          var _ref2 = _slicedToArray4(_ref, 2), color = _ref2[0], linksPerWidth = _ref2[1];
